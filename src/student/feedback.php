...
<body>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-6 col-md-6 col-sm-4 m-2 mt-3">
        <div class="card shadow-lg rounded-xl mt-3 p-5 bg-white">
              ...
              <form class="" action="" method="POST" role="form">
                <div class="input-group">
                  <div class="form-group">
                    <textarea class="form-control" rows="3" cols="50" name="news"></textarea>
                  </div>
                </div>
