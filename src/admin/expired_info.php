...
<body class="bg-white" id="page-top" data-spy="scroll" data-target=".fixed-top">
  ...
  <div class="container">
    <div class="row">
      <h3 class="col"><b>Book expired Information</b></h3>
    </div>
        ...
        if (isset($_SESSION['admin_login_user'])) {
          ...
          if (mysqli_num_rows($query) == 0) {
            ...
            ?>
              ...
              echo "<td class='font-weight-bold text-danger'>";
              echo $row['approve'];
              echo "</td>";
            ...
            <?php
              echo "<td>";
              echo "<button class='font-weight-bold btn btn-success btn-block' name='b_submit'><i class='fa fa-cart-plus'></i>";
              echo "</button>";
              echo "</td>";
              echo "</tr>";
              echo "</form>";
